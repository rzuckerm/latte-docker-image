LATTE_VERSION := $(shell cat LATTE_VERSION)
LATTE_DEPS := $(wildcard LATTE_*)
DOCKER_TAG_PREFIX := rzuckerm/latte:$(LATTE_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(LATTE_DEPS)
